    ...
    <PageContainer className="pt-16">
      <div>
        ...
        <div className="mt-6 flex flex-col gap-2">
          <Button className="w-full gap-2 rounded-none" size="lg">
            Start Exploring
            <ChevronRightIcon className="w-4 h-4" />
          </Button>
          <Button
            className="w-full gap-2 rounded-none bg-background border border-primary text-primary hover:bg-accent"
            size="lg"
          >
            Get a Quick Demo
